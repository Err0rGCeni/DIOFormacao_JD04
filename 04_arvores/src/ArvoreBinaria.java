public class ArvoreBinaria<T extends Comparable<T>> {
    ...
    private BinNo<T> inserir(BinNo<T> atual, BinNo<T> novoNo) {
        if (atual == null) {
            // Está na raiz, retorna o novo nó
            return novoNo;
        } else if (novoNo.getConteudo().compareTo(atual.getConteudo()) < 0) {
            // Se o novo nó é menor do que o atual
            atual.setNoEsq(this.inserir(atual.getNoEsq(), novoNo));
        } else {
            // Se o novo nó é maior do que o atual
    ...
    public void remover(T conteudo) {
        try {
            ...
            while (atual != null && !atual.getConteudo().equals(conteudo)) {
                pai = atual;
                // Se o conteudo é menor do que o atual (esquerda ou direita)
            ...
            if (atual == null) {
                System.out.print("Conteudo não encontrado. Bloco Try");
            }
